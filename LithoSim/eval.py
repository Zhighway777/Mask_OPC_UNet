...
parser.add_argument('--kernels_root', type=str,
                    default='LithoSim/lithosim/lithosim_kernels/bin_data')
parser.add_argument('--mask_root', type=str, default='LithoSim/output/refine_mask_out/')
parser.add_argument('--mask_file_name', type=str, default='M1_test1_res.png')
parser.add_argument('--layout_root', type=str, default='test_dataset/mask/')
...
def eval():
    ...
    kernel_torch_data_path = 'LithoSim/lithosim/lithosim_kernels/torch_tensor'
