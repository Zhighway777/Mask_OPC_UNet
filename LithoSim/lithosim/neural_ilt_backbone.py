...
def double_conv(in_channels, out_channels):
    return nn.Sequential( #Sequential connects different models into a single one model
...
class ILTNet(nn.Module): #super's father class
    r"""
    ILTNet: 
    The main backbone model of Neural-ILT, a standard U-Net + ILT correction layer
    """
    def __init__( #when you call the class ILTNet, the parameters below will be init automatic
        self,
        n_class,
        kernels,
        kernels_ct,
        ...
        super(ILTNet, self).__init__()#subclass when call subclass, you need set the father class first
